<#
The following PowerShell script will perform the following:
...
Please see my blog post here for more information: http://terenceluk.blogspot.com/2021/09/granting-csp-foreign-principal-reader.html
#>
